...
if (!fs.existsSync(PRODUCTS_FILE)) {
  writeProducts([
    { id: 1, name: 'Aceite girasol 1.5L', category: 'Abarrote', price: 1800, offer_price: 1500, is_offer: true, description: 'Caja x 12 unidades', image_url: null, created_at: new Date().toISOString() },
    { id: 2, name: 'Harina 0000 x 1kg', category: 'Abarrote', price: 950, offer_price: null, is_offer: false, description: 'Bolsa x 25kg disponible', image_url: null, created_at: new Date().toISOString() },
    { id: 3, name: 'Arroz largo fino 1kg', category: 'Abarrote', price: 1100, offer_price: null, is_offer: false, description: 'Caja x 20 unidades', image_url: null, created_at: new Date().toISOString() },
    ...
    { id: 7, name: 'Yerba mate 500g', category: 'Abarrote', price: 2800, offer_price: 2500, is_offer: true, description: 'Caja x 10 unidades', image_url: null, created_at: new Date().toISOString() },
    { id: 8, name: 'Azúcar x 1kg', category: 'Abarrote', price: 1200, offer_price: null, is_offer: false, description: 'Bolsa x 25kg disponible', image_url: null, created_at: new Date().toISOString() },
  ]);
}
